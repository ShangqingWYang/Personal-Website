...
export default function HomePage() {
  ...
  style={{
    background: "linear-gradient(90deg, #C0C0C0, #E0E0E0, #FFFFFF, #E0E0E0, #C0C0C0)",
    WebkitBackgroundClip: "text",
    WebkitTextFillColor: "transparent",
...
>
  ...
  <h2
    ...
    style={{
      ...
      WebkitBackgroundClip: "text",
      WebkitTextFillColor: "transparent",
      animation: "shineMove 10s ease-in-out infinite, shimmerPulse 4s ease-in-out infinite",
    }}
  >
    Get in Touch
  </h2>
...
>
  ...
  {/* Input field — sits inside the glow capsule */}
  <input
    type="email"
    name="email"
  ...
  {/* Send button — completely below the glow capsule */}
  <button
    type="submit"
